...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function SEG2new = pairwiseAlignment(SEG_fixed,SEG_moving)
%% Read data
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Rotate 
    baryCentreLV1new(1,1) = mean(SEG1new.EndoPoints.Frame{1}(1:80,1));
    baryCentreLV1new(1,2) = mean(SEG1new.EndoPoints.Frame{1}(1:80,2));
    baryCentreLV1new(1,3) = mean(SEG1new.EndoPoints.Frame{1}(1:80,3));

    baryCentreRV1new(1,1) = mean(SEG1new.RVEndoPoints.Frame{1}(1:80,1));
    baryCentreRV1new(1,2) = mean(SEG1new.RVEndoPoints.Frame{1}(1:80,2));
    baryCentreRV1new(1,3) = mean(SEG1new.RVEndoPoints.Frame{1}(1:80,3));

    baryCentreLV2new(1,1) = mean(SEG2new.EndoPoints.Frame{1}(1:80,1));
    baryCentreLV2new(1,2) = mean(SEG2new.EndoPoints.Frame{1}(1:80,2));
    baryCentreLV2new(1,3) = mean(SEG2new.EndoPoints.Frame{1}(1:80,3));

    baryCentreRV2new(1,1) = mean(SEG2new.RVEndoPoints.Frame{1}(1:80,1));
    baryCentreRV2new(1,2) = mean(SEG2new.RVEndoPoints.Frame{1}(1:80,2));
    baryCentreRV2new(1,3) = mean(SEG2new.RVEndoPoints.Frame{1}(1:80,3));
