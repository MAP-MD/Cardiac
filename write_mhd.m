% Function from the Medical Image Processing Toolbox by Alberto Gomez
% 01 May 2013 (Updated 27 Jun 2016)
% Classes and functions for N-dimensional medical image processing, 
% inspired by ITK, available from the MathWorks website
